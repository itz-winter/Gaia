...
public class AimA extends Check {
    ...
    public void handle(Player player, PlayerData data) {
        ...
        boolean yawSnapped = deltaYaw > 1.0f && deltaYaw % 1.0f == 0;
        boolean pitchSnapped = deltaPitch > 1.0f && deltaPitch % 1.0f == 0;
        ...
        if (yawSnapped && pitchSnapped) {
            ...
            if (buffer > 3) {
                ...
                data.setBuffer("aim_a_buffer", 1);
            }
        } else {
            data.decreaseBuffer("aim_a_buffer", 0.25);
        }
    }
}
